...
export const validExperienceGraphFixture = {
  ...
  presentation: {
    title: "빛을 따라 흐르는 강",
    subtitle: "모리와 함께 만나는 쇠라의 색 이야기",
    summary: "강물 위에서 달라지는 빛과 색을 관찰하며 쇠라의 시선을 따라가는 이야기예요.",
    coverMediaId: "media.world-cover",
    coverAltText: "노을빛 강가에서 반짝이는 물결을 바라보는 모리",
  ...
  chatGraph: {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: "cinematic",
        title: "강물 위에서 춤추는 빛",
        description: "쇠라가 바라본 강물의 빛과 색을 세로 애니메이션으로 살펴봐요.",
        mediaId: "media.river-light",
        posterMediaId: "media.river-light-poster",
        subtitleMediaId: "media.river-light-subtitles",
        autoplay: false,
  ...
  mediaManifest: {
    ...
    assets: [
      ...
      {
        id: "media.river-light-poster",
        releaseVersion: RELEASE_VERSION,
        kind: "image",
        storageKey: "releases/world.seurat-river/1.0.0/river-light-poster.webp",
        mimeType: "image/webp",
      ...
      {
        id: "media.river-light-subtitles",
        releaseVersion: RELEASE_VERSION,
        kind: "subtitle",
        storageKey: "releases/world.seurat-river/1.0.0/river-light.ko.vtt",
        mimeType: "text/vtt",
      ...
      {
        id: "media.world-cover",
        releaseVersion: RELEASE_VERSION,
        kind: "image",
        storageKey: "releases/world.seurat-river/1.0.0/world-cover.webp",
        mimeType: "image/webp",
