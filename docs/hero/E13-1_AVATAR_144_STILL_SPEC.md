...
| 항목 | 값 |
|---|---|
| **스펙 프리즈 승인** | **2026-07-05 대표 승인** (구성 3×8×6·시트 규격·QC 기준 — 채팅 승인 기록) |
| 샘플 경로 | `tmp/avatar-samples/` |
| 샘플 확인 일자 | **2026-07-05 대표 승인** (채팅 승인 기록, 총 생성비 $0.117) |
| 승인 샘플 | `b1-p1-c1.png`, `b2-p4-c3.png`, `b3-p8-c6.png` — 리드 QC(실사 유사 0·KINDYTOY 룩 정합) + 대표 확인 |
